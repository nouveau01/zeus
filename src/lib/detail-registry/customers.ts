        ...
        sections: [
          {
            ...
            fields: [
              ...
              { fieldName: "contact", label: "Primary Contact", column: 1, visible: true, labelWidth: 90 },
              { fieldName: "phone", label: "Phone", column: 1, visible: true, labelWidth: 90 },
              { fieldName: "fax", label: "Fax", column: 1, visible: true, labelWidth: 90 },
              { fieldName: "cellular", label: "Cellular", column: 1, visible: true, labelWidth: 90 },
              { fieldName: "email", label: "e-mail", column: 1, visible: true, labelWidth: 90 },
              { fieldName: "website", label: "Web Site", column: 1, visible: true, labelWidth: 90 },
            ],
          },
        ],
      },
