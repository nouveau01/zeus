...
export const MODULE_REGISTRY: ModuleDefinition[] = [
  ...
  // Dispatch
  {
    ...
    fields: [
      ...
      { fieldName: "nature", label: "Nature" },
      { fieldName: "zone", label: "Zone" },
      { fieldName: "scheme", label: "Scheme" },
      { fieldName: "caller", label: "Caller" },
      { fieldName: "worker", label: "Worker" },
      { fieldName: "territory", label: "Territory" },
      { fieldName: "schedTimeStatus", label: "Sched Time Status" },
      { fieldName: "account", label: "Account" },
      { fieldName: "address", label: "Address" },
  ...
  // Global (shared picklists)
  {
    ...
    fields: [
      ...
      { fieldName: "jobType", label: "Job Type" },
    ],
  },
];
